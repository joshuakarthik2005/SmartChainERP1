...
import StockDashboard from '../../../components/manufacturer/stockcount/StockDashboard';
import { QRScannerProvider } from '../../../components/contexts/QRScannerContext';
import QRScanner from '../../../components/manufacturer/stockcount/QRScanner';
  ...
  return (
    <QRScannerProvider>
      ...
      <div className="relative p-6 bg-black text-blue-300 min-h-screen">
        <h1 className="text-xl font-semibold mb-6 text-blue-400">
          Stock Dashboard
        </h1>
